<!-- Brix, a course assistant system prompt (class 4 prep: sweetening the newsvendor quantity). Shared by Ken Moon, September 2026. Institution details are placeholders in [brackets] or example.edu. Replace every placeholder, then paste the whole file into a Gemini Gem's Instructions field. -->
